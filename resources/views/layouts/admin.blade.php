...
<ul class="menu-nav">
                    ...
                    <li class="menu-item rounded" style="background: green">

                    <a href="{{ route('admin.cv.index') }}" class="menu-link">
                    <span class="svg-icon menu-icon">
                    <i style="color: white" class="fa fa-eye mr-1"> </i>
                    </span>
                    <span class="menu-text" style="color: white">  PREVIEW CV </span>
                    </a>

                    </li>

                    <li class="menu-item rounded mt-2" style="background: rgb(53, 49, 184)" aria-haspopup="true">

                    <a href="{{ route('admin.cv.index') }}" class="menu-link text-center">
                    <span class="svg-icon menu-icon">
                    <i style="color: white"  class="fa fa-file mr-1"> </i>
                    </span>
                    <span class="menu-text" style="color: white">  Download Cv PDF </span>
                    </a>
...
<h4 class="menu-text">Personal Info</h4>
...
<a href="{{ route('admin.personals.index') }}" class="menu-link menu-toggle">
<span class="svg-icon menu-icon">
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
<a href="{{ route('admin.experiences.index') }}" class="menu-link menu-toggle">
<span class="svg-icon menu-icon">
<!--begin::Svg Icon | path:dashboard_files/assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
<a href="{{ route('admin.educations.index') }}" class="menu-link menu-toggle">
<span class="svg-icon menu-icon">
<!--begin::Svg Icon | path:dashboard_files/assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
<a href="{{ route('admin.projects.index') }}" class="menu-link menu-toggle">
<span class="svg-icon menu-icon">
<!--begin::Svg Icon | path:dashboard_files/assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <span class="menu-text">Add Skills</span>
    </a>
    </li>
    @endcan
    </ul>
...
<!--begin::Page Title-->
<h6 class="text-muted font-weight-bold mt-2 mb-2 mr-5">Dashboard</h6>
<!--end::Page Title-->
<!--begin::Actions-->
<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
<h6 class="text-muted font-weight-bold mt-2 mb-2 mr-5">{{$category}}</h6>
<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
<span href="#" class="font-weight-bolder">{{$title}}</span>
<!--end::Actions-->
</div>
<!--end::Info-->
...
<script src="{{asset ('dashboard_files/assets/js/pages/custom/wizard/wizard-1.js') }}"></script>
...
{{-- <script>
    $(document).ready(function() {
        $('li').click(function() {
            $('li.menu-item.menu-item-active').removeClass("menu-item-submenu");
